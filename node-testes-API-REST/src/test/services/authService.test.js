...
describe('Testando a authService.cadastrarUsuario', () => {
  ...
  it.skip('A senha do usuario precisa ser criptografada quando for salva no banco de dados', async () => {
    const data = {
      nome: 'John Doe',
  ...
  it.skip('Ao cadastrar um usuario deve ser retornado uma mensagem informando que o usuario foi cadastrado', async () => {
    const data = {
      nome: 'John Doe',
      email: 'johndoe@example.com',
      senha: 'senha123',
  ...
  it.skip('Ao cadastrar um usuario validar retorno do usuario', async () => {
    const data = {
      nome: 'John Doe',
      email: 'johndoe@example.com',
      senha: 'senha123',
